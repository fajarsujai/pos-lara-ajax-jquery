      ...
      <div class="col-md-12">
        <div class="card mt-5">
          <div class="card-header">
             <div class="col-md-12">
                 <h4 class="card-title">Datatable Unit - nicesnippets.com  
                         ...
                         <form id="ItemForm" name="ItemForm" class="form-horizontal">
                            <input type="hidden" name="Item_id" id="Item_id">
                             <div class="form-group">
                                 ...
                                 <div class="col-sm-12">
                                     <input type="text" class="form-control" id="unit_name" name="unit_name" placeholder="Enter Name" value="" maxlength="50" required="">
                                 </div>
                             </div>
...
<script type="text/javascript">
    ...
    $('body').on('click', '.editItem', function () {
      ...
      $.get("{{ route('unit.index') }}" +'/' + Item_id +'/edit', function (data) {
